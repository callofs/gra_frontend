<template>
  <section class="panel card">
    <div class="panel-header">
      <div>
        <div class="panel-title">贴文审核</div>
        <div class="panel-subtitle">处理社区贴文的上架、屏蔽与敏感内容复核。</div>
      </div>
    </div>
    ...
    <div class="table-list">
      <div v-for="item in items" :key="item.id" class="table-row">
        <div class="row-main">
          ...
          <div class="row-meta">作者：{{ item.author }} · 板块：{{ item.board }} · 举报数：{{ item.reportCount }}</div>
        </div>
...
const emit = defineEmits(['preview', 'approve', 'offline'])
</script>
